...
Чтобы создать новую ветку "Данный текст добавлен для создания искуственного конфликта при слиянии 2 веток
...
Появление конфликта возможно при слиянии двух веток в которых в одних и тех же строчках присутствует разная информация.
